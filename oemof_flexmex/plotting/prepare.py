...
def onxaxes_preparation(plot_data):
...
def conversion_electricity_FlexMex2_1(plot_data, df_demand):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def conversion_electricity_FlexMex2_2(plot_data, df_demand):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def conversion_heat_FlexMex2_2(plot_data, df_demand):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def electricity_storage_FlexMex2_1(plot_data):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def electricity_storage_FlexMex2_2(plot_data):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def heat_storage_FlexMex2_2(plot_data):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def costs_FlexMex2_1(plot_data):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
...
def costs_FlexMex2_2(plot_data):
    plot_data = onxaxes_preparation(plot_data)
    parameters = load_yaml(os.path.join(dir_name, "parameters.yaml"))
