...
from oemof.solph import Flow, Investment, sequence, Source, Bus, Transformer
...
TYPEMAP.update({"asymmetric storage": AsymmetricStorage, "reservoir": ReservoirWithPump})
