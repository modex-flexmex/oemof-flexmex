...
man_pages = [
    ("index", "oemof", u"oemof-flexmex documentation", [u"Reiner Lemoine Institut"], 1)
]
...
texinfo_documents = [
    (
        ...
        u"Author",
        "Jann Launer",
        "An open energy system model for flexibility" "in the European energy system.",
        "",
    )
]
